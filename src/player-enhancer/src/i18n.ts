const TRANSLATIONS = {
  en: {
    ...
    'frameExport.selected':   'Selected {selected} / Total {total} frames',
    'frameExport.prev':       '← Previous',
    'frameExport.next':       'Next →',
  ...
  zh: {
    ...
    'frameExport.button':     '帧导出',
    'frameExport.title':      '帧导出',
    'frameExport.loading':    '加载中...',
    'frameExport.close':      '关闭',
    'frameExport.selected':   '已选 {selected} / 总数 {total} 帧',
    'frameExport.prev':       '← 向前',
    'frameExport.next':       '向后 →',
  ...
  ja: {
    ...
    'frameExport.selected':   '選択 {selected} / 合計 {total} フレーム',
    'frameExport.prev':       '← 前へ',
    'frameExport.next':       '次へ →',
